...
class MulherScreen: UIView {
    
    
    weak var delegate : imcMulher?
    
    lazy var imageView : UIImageView = {
        
        var image = UIImageView()
        image.translatesAutoresizingMaskIntoConstraints = false
        image.image = UIImage(named: "Mulher")
